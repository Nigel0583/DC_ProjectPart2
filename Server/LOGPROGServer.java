...
/**
 * <b>REVERSEPROG Server Stub</b>
 * This class was automatically generated by Jrpcgen from the RPC/XDR file "stdin". <br>
 * REVERSEPROG: was interface
 */

public abstract class LOGPROGServer extends JRPCServer {

    /**
     * Program ID of the interface.
     */
    public static final int REVERSEPROG = 78;

    /**
     * Version ID of the interface.
     */
    public static final int LOGSEVERS = 1;

    public static final int reverse = 1;

    /**
     * Constructor that creates an RPC server which implements the "REVERSEPROG" interface.
     *
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGPROGServer() throws RPCError {
        super(REVERSEPROG, LOGSEVERS, true);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGPROGServer(int port) throws RPCError {
        super(REVERSEPROG, LOGSEVERS, true);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGPROGServer(int port, boolean do_tcp, boolean do_udp, boolean do_rpcb) throws RPCError {
        super(REVERSEPROG, LOGSEVERS, do_rpcb);
     ...
     * @throws RPCError Thrown if the call fails for any reason.
     */
    public LOGPROGServer(int port, int prog_id, boolean do_tcp, boolean do_udp, boolean do_rpcb) throws RPCError {
        super(prog_id, LOGSEVERS, do_rpcb);
    ...
    public abstract String Login1(String arg1);
}
